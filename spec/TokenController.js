...
class TokenModelStub {
    constructor() { this.trialConcluded_ = false; }
    ...
    concludeTrial() {
        this.trialConcluded_ = true;
    }

    trialConcluded() { return this.trialConcluded_; }
}
...
describe("TokenController", () => {
    ...
    it("should determine whether red circle is left of yellow square after drag part 2", function() {
        setTokenPosition(
            this.control,
            { color: Color.yellow, shape: Shape.square },
            {
