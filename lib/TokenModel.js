...
function submitTokenInteraction(tokenModel, interaction, comparator) {
  ...
  if (
    ...
    if (
      tokenModel.interactions[tokenModel.interactionCollectionIndex].length ===
      0
    ) {
  ...
  } else tokenModel.interactionCollectionIndex = tokenModel.interactions.length;
}
