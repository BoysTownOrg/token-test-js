...
export class TokenController {
  ...
  notifyThatTokenHasBeenDragged() {
    this.tokenBeingDragged = {
      color: color(this.control.tokenDraggedColor()),
      shape: this.control.tokenDraggedIsCircle() ? Shape.circle : Shape.square,
    };
  }
  ...
  notifyThatTokenHasBeenDroppedOnto() {
    this.model.submitDualTokenInteraction({
      ...
      secondToken: {
        color: color(this.control.tokenDroppedOntoColor()),
        shape: this.control.tokenDroppedOntoIsCircle()
          ? Shape.circle
          : Shape.square,
      },
