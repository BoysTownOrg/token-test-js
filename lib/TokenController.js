...
export class TokenController {
  ...
  movedTokenIsBetween(tokenA, tokenB) {
    ...
    const slopeFromLeftToRight =
      (pointFurthestLeft.y - pointFurthestRight.y) /
      (pointFurthestLeft.x - pointFurthestRight.x);
    return (
      pointFurthestLeft.x + pointFurthestLeft.y * slopeFromLeftToRight <=
        tokenMovedCenter.x + tokenMovedCenter.y * slopeFromLeftToRight &&
      tokenMovedCenter.x + tokenMovedCenter.y * slopeFromLeftToRight <=
        pointFurthestRight.x + pointFurthestRight.y * slopeFromLeftToRight
    );
  }
}
