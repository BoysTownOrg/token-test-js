...
export class TokenController {
  ...
  movedTokenIsBetween(tokenA, tokenB) {
    ...
    const slopeFromAToB =
      (tokenACenter.y - tokenBCenter.y) / (tokenACenter.x - tokenBCenter.x);
    return (
      tokenACenter.x + tokenACenter.y * slopeFromAToB <=
        tokenMovedCenter.x + tokenMovedCenter.y * slopeFromAToB &&
      tokenMovedCenter.x + tokenMovedCenter.y * slopeFromAToB <=
        tokenBCenter.x + tokenBCenter.y * slopeFromAToB
    );
  }
}
